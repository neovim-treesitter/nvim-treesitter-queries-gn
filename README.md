# nvim-treesitter-queries-gn

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gn/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gn/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gn**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gn",
...
- [ ] Changes are scoped to `gn` — do not include files for other languages
